      ...
      <aside className="hidden md:flex flex-col w-64 bg-slate-900 text-white p-6 shadow-xl sticky top-0 h-screen">
        ...
        <div className="mt-auto pt-6 border-t border-slate-800">
          <div className="flex items-center gap-3 text-slate-400 text-sm">
            <div className="w-8 h-8 rounded-full bg-indigo-900 flex items-center justify-center text-[10px] font-black border border-indigo-700 text-white">PRO</div>
            <div>
              <p className="font-medium text-slate-200 leading-none mb-1 text-xs">GestãoFoto Cloud</p>
              <p className={`text-[10px] font-black uppercase tracking-widest flex items-center gap-1 ${isCloudSynced ? 'text-emerald-400' : 'text-amber-400'}`}>
                ...
                {isSyncing ? 'Sincronizando...' : isCloudSynced ? 'Cloud Ativa' : 'Offline'}
              </p>
            </div>
          </div>
        </div>
