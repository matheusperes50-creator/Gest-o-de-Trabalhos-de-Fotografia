...
const BudgetModal: React.FC<BudgetModalProps> = ({ isOpen, onClose }) => {
  ...
  const copyBudget = async () => {
    ...
    let message = `📸 *PROPOSTA DE TRABALHO*\n`;
    message += `━━━━━━━━━━━━━━━━━━━━\n\n`;
    ...
    message += `📅 *Data:* ${formData.date ? formatLocalDate(formData.date) : 'A definir'}\n`;
  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-center justify-center p-4 bg-slate-900/90 backdrop-blur-md">
      <div className="bg-white w-full max-w-xl rounded-[2.5rem] shadow-2xl overflow-hidden flex flex-col border border-white/20">
        <div className="p-8 border-b border-slate-100 flex justify-between items-center bg-gradient-green text-white">
          <div>
        ...
        <div className="p-8 space-y-8 overflow-y-auto max-h-[75vh]">
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-2 mb-2">
              <span className="w-5 h-5 bg-emerald-100 text-emerald-600 rounded-full flex items-center justify-center text-[10px] font-black">1</span>
            ...
            <div className="bg-slate-50 p-6 rounded-3xl border border-dashed border-slate-200">
              ...
              <button 
                ...
                className={`w-full py-4 rounded-2xl font-black text-xs uppercase tracking-widest transition-all flex items-center justify-center gap-3 ${copyingInitial ? 'bg-emerald-500 text-white shadow-emerald-100' : 'bg-white border-2 border-emerald-600 text-emerald-600 hover:bg-emerald-50 shadow-sm'}`}
              >
          ...
          <section className="space-y-4 pt-4 border-t border-slate-100">
            <div className="flex items-center gap-2 mb-2">
              <span className="w-5 h-5 bg-emerald-100 text-emerald-600 rounded-full flex items-center justify-center text-[10px] font-black">2</span>
            ...
            <div>
              <div className="flex justify-between items-center mb-2 px-1">
                ...
                <button 
                  ...
                  className="text-[9px] font-black text-emerald-600 uppercase hover:underline disabled:opacity-30"
                >
